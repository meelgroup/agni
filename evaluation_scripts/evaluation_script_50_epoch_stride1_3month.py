...
model_filename = 'model_3month.hdf5'
eval_set_log_filename = 'model_3month_eval_set_log_aug19.txt'
eval_set_directory = './preprocessed_data_2019_aug_with_sept_fire_test/'
prediction_output_file = 'prediction_label_3month_aug19.pickle'
...
def parse_input_data_function(filename):
    ...
    # at this point we only want the latest 6 instances which roughly corresponds to 3 months
