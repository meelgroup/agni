...
eval_set_log_filename = 'baseline_model_eval_set_log_aug19.txt'
eval_set_directory = './preprocessed_data_2019_aug_with_sept_fire_test/'
prediction_output_file = 'baseline_prediction_label_aug19.pickle'

#######################

# defining custom loss function ---- custom loss function unused in baseline
